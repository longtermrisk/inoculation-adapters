...
This library supports training inoculation adaptors as follows: 
...
with apply(llm, LoraSpec()):                               # 1. finetune an inoculation adaptor on undesirable trait
...
We show an example of inoculation adaptors outperforming baselines in one setting. 
